const FeaturesSection = () => {
    return (
        <div className="w-full bg-base-200 py-10 px-5 md:px-10">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 items-center">

                {/* Left Section */}
                <div className="flex-1">
                    <h1 className="text-3xl font-bold text-base-content mb-4">About Us</h1>
                    <p className="text-base-content opacity-80 mb-4 text-xl">
                    ...
                    <p className="text-base-content opacity-80 text-xl">
                ...
                <div className="flex-1 relative rounded-lg overflow-hidden shadow-lg">
                    ...
                    />
                    <div className="absolute bottom-0 left-0 w-full bg-primary text-white px-6 py-6 md:py-8 skew-y-[-5deg]">
                        <div className="skew-y-[5deg]">
                            <p className="text-2xl leading-snug font-semibold relative">
                                <span className="text-5xl font-bold text-primary-content/70 absolute -left-4 top-[-20px]">“</span>

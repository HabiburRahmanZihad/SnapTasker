            ...
            <div className="bg-white/10 backdrop-blur-xl text-white px-12 py-10 rounded-2xl shadow-2xl w-full max-w-xl border border-white/20">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        aria-label="Sign Up"
                        className="w-full flex items-center justify-center gap-2 text-2xl font-semibold py-3 rounded-md bg-white text-[#4B0082] font-rancho transition hover:bg-[#4B0082] hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
                    >
                ...
                <p className="mt-8 text-center text-base text-white/90">
                    ...
                    <Link to="/signin" className="underline hover:text-white">
                        Sign In
                    </Link>
                </p>
            </div>
